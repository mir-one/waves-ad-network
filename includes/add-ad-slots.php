...
$admin_url = menu_page_url( 'wan-add-ad-slots',false); 
...
if(isset($_GET['waves-network-slot-edit-nonce']) && current_user_can('administrator') && wp_verify_nonce($_GET['waves-network-slot-edit-nonce'], 'waves-network-slot-edit-action')){
	if(isset($_GET['id'])){
...
<form action='<?php echo get_admin_url(); ?>admin-post.php' method="post">
	<?php wp_nonce_field( 'waves-network-slot-form-action', 'waves-network-slot-form-field'); ?>
	...
	<p class="submit">
		<input type="submit" name="tn_ad_slot_submit" id="submit" class="button button-primary" value="<?php echo $btntxt;?> Ad Segment">
	</p>
</form>
        ...
        <tr class="alternate" valign="top"> 
            ...
            <td class="column-columnname"><?php esc_html_e($value->ad_segment_name);?>
                <div class="row-actions">
                    ...
                    <span><a href="<?php print wp_nonce_url($admin_url.'&action=edit&id='.intval($value->id), 'waves-network-slot-edit-action', 'waves-network-slot-edit-nonce'); ?>">Edit</a> |</span>

                    <span><a href="<?php print wp_nonce_url($admin_url.'&action=delete&id='.intval($value->id), 'waves-network-slot-edit-action', 'waves-network-slot-edit-nonce'); ?>">Delete</a></span>
                </div>
            </td>
            ...
            <td class="column-columnname"><?php esc_html_e("[WAN-" . $value->ad_segment_name . "]");?></td>
