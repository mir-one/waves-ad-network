...
$admin_url = menu_page_url( 'wan-approve-ad',false); 
?>
...
if(isset($_GET['id']) && isset($_GET['action'])){
    if(wp_verify_nonce($_GET['waves-network-approve-nonce'], 'waves-network-approve-action') && current_user_can('administrator')){
    ...
    ?>
        ...
        <tr class="alternate" valign="top"> 
            ...
            <td class="column-columnname">
                <a href="https://wavesexplorer.com/tx/<?php echo $value->txid;?>" target="_blank">
            ...
            <td class="column-columnname"><?php echo esc_html("[WAN-" . $value->ad_segment_name . "]");?></td>
            ...
            <td class="column-columnname">
                ...
                <?php }else{ ?>
                    ...
                    <a href="<?php print wp_nonce_url($admin_url.'&action=1&id='.intval($value->ID), 'waves-network-approve-action', 'waves-network-approve-nonce'); ?>">Approve</a>
                    <a href="<?php print wp_nonce_url($admin_url.'&action=0&id='.intval($value->ID), 'waves-network-approve-action', 'waves-network-approve-nonce'); ?>">Reject</a> 
